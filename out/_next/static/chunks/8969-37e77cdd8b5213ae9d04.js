  ...
  [8969],
  {
    ...
    78892: function (e) {
      ...
      e.exports = function (e, n) {
        ...
        for (; c < i.length; )
          (t.lastIndex = c),
            (r = t.exec(i)),
            (a = i.slice(c, r ? r.index : i.length)) &&
              (o
                ? "#" === o
                  ? (l.id = a)
                  : l.className
      ...
      e.exports = function (e, t, n) {
        ...
        return function (e, n) {
          ...
          (i.tagName = o && l.call(o, u) ? o[u] : u),
            n && c(n, i) && (s.unshift(n), (n = null));
          if (n) for (a in n) p(i.properties, a, n[a]);
          d(i.children, s),
            "template" === i.tagName &&
      ...
      function d(e, t) {
        ...
        if ("string" !== typeof t && "number" !== typeof t)
          if ("object" === typeof t && "length" in t)
            for (n = -1, a = t.length; ++n < a; ) d(e, t[n]);
          else {
    ...
    89435: function (e) {
      ...
      e.exports = function (e) {
        var n,
          a = "&" + e + ";";
        if (
          (((t = t || document.createElement("i")).innerHTML = a),
    ...
    57574: function (e, t, n) {
      ...
      e.exports = function (e, t) {
        ...
        return (function (e, t) {
          ...
          for (; ++Y < V; )
            if ((10 === A && (K = j[q] || 1), 38 === (A = e.charCodeAt(Y)))) {
              ...
              for (
                ...
                (p += d(_)), C === g && c.call(a, p) && ((n = p), (I = a[p]));
              (i = 59 === e.charCodeAt(M)) &&
                (M++, (r = C === g && l(p)) && ((n = p), (I = r))),
                (D = 1 + M - v),
                (i || F) &&
          ...
          function ee(e, t) {
            var n = J();
            (n.column += t), (n.offset += t), z.call($, E[e], n, e);
          }
          function te() {
            Z &&
              (Q.push(Z), U && U.call(G, Z, { start: x, end: J() }), (Z = ""));
          }
        })(e, i);
      };
    ...
    28325: function (e, t, n) {
      var a = (function (e) {
          ...
          a = {
            ...
            highlightElement: function (n, o, r) {
              ...
              if ((a.hooks.run("before-sanity-check", c), !c.code))
                return (
                  a.hooks.run("complete", c), void (r && r.call(c.element))
                );
              ...
              for (var m = 0; m < g.length; ++m) {
                ...
                for (
                  ...
                  if (!(k instanceof o)) {
                    ...
                    var O = w[0],
                      x = k.slice(0, I),
                      L = k.slice(I + O.length),
                      D = _ + k.length;
                    u && D > u.reach && (u.reach = D);
                    var M = T.prev;
                    x && ((M = l(t, M, x)), (_ += x.length)),
                      c(t, M, R),
                      (T = l(t, M, new o(p, f ? a.tokenize(O, f) : O, S, O))),
                      L && l(t, T, L),
                      R > 1 &&
                        i(e, t, n, T.prev, _, { cause: p + "," + m, reach: D });
                  }
                }
              }
            }
        ...
        function l(e, t, n) {
          var a = t.next,
            o = { value: n, prev: t, next: a };
          return (t.next = o), (a.prev = o), e.length++, o;
        }
        function c(e, t, n) {
          for (var a = t.next, o = 0; o < n && a !== e.tail; o++) a = a.next;
          (t.next = a), (a.prev = t), (e.length -= o);
        }
        if (
          ((e.Prism = a),
    ...
    46577: function (e, t, n) {
        ...
        if (b) {
          ...
          if (r) {
            ...
            h = s({}, d, {
              ...
              style: p(d.className, Object.assign({}, d.style, o), n),
            });
          } else h = s({}, d, { className: g(d.className) });
          var T = E(t.children);
          return l.createElement(b, c({ key: i }, h), T);
        }
      }
      var b = /\n/g;
      function f(e) {
        var t = e.codeString,
          n = e.codeStyle,
          a = e.containerStyle,
          o = void 0 === a ? { float: "left", paddingRight: "10px" } : a,
          r = e.numberStyle,
          i = void 0 === r ? {} : r,
      ...
      function E(e, t, n) {
        ...
        return s(
          {},
          {
            ...
            minWidth: ((a = n), "".concat(a.toString().length, ".25em")),
            paddingRight: "1em",
            textAlign: "right",
            userSelect: "none",
          },
      ...
      function S(e) {
        var t = e.children,
          ...
          u = e.showLineNumbers,
          p = e.wrapLongLines,
          g = "function" === typeof l ? l(n) : l;
        if (((g.className = d), n && r)) {
          var m = E(a, n, o);
          t.unshift(h(n, m));
        }
        return (
      ...
      function y(e) {
        for (
          ...
          var o = e[a];
          if ("text" === o.type)
            n.push(S({ children: [o], className: r(new Set(t)) }));
          else if (o.children) {
            var i = t.concat(o.properties.className);
            n = n.concat(y(o.children, i));
          }
        }
        return n;
      }
      function A(e, t, n, a, o, r, i, s, l) {
        var c,
          d = y(e.value),
          u = [],
          p = -1,
        ...
        function A(e, n) {
          var a =
            arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : [];
          return t || a.length > 0 ? m(e, n, a) : f(e, n);
        }
        for (
          var T = function () {
            var e = d[g],
        ...
        I =
          ...
          function (e) {
            var t = e.language,
              ...
              U = void 0 === F ? "code" : F,
              B = e.code,
              z = void 0 === B ? (Array.isArray(n) ? n[0] : n) : B,
              G = e.astGenerator,
              H = a(e, [
                "language",
                "children",
            ...
            var K = A(q, v, L, b, E, y, q.value.length + y, N, O);
            return (
              (u.style = s(
                {},
                u.style,
        ...
        (m.Token.stringify = function (e, t, n) {
          ...
          if ("Array" === m.util.type(e))
            return (function (e, t) {
              ...
              (r = -1), (o = a.length);
              for (; ++r < o; ) (n = a[r]), (a[r] = m.Token.stringify(n, t, a));
              return a;
            })(e, t);
          (a = {
            type: e.type,
      ...
      function t(e) {
        !(function (e) {
          ...
          (e.languages.csharp = e.languages.extend("clike", {
            ...
            "class-name": [
              {
                pattern: n(/(\busing\s+static\s+)<<0>>(?=\s*;)/.source, [h]),
                lookbehind: !0,
                inside: _,
              },
              {
              ...
              {
                pattern: n(/(\bcatch\s*\(\s*)<<0>>/.source, [h]),
                lookbehind: !0,
                inside: _,
              },
        ...
        !(function (e) {
          var t = {
            ...
            a = {
              ...
              string: { pattern: /"(?:\\\S|[^"\\])*"/, greedy: !0, inside: n },
            },
            o = function (e) {
                  ...
                  !(function (t, n) {
                    ...
                    if (o) {
                      ...
                      if (!r) {
                        ...
                        r = (o = e.languages.insertBefore(t, "comment", i))[a];
                      }
                      if (
                        (r instanceof RegExp && (r = o[a] = { pattern: r }),
                        Array.isArray(r))
                      )
    ...
    39303: function (e) {
      ...
      function t(e) {
        !(function (e) {
          var t = /\((?:[^()]|\((?:[^()]|\([^()]*\))*\))*\)/.source,
            n = /(?:\w+(?:<braces>)?|<braces>)/.source.replace(
              /<braces>/g,
              function () {
                return t;
              }
    ...
    88393: function (e) {
      ...
      function t(e) {
        !(function (e) {
          ...
          ["c", { lang: "c++", alias: "cpp" }, "fortran"].forEach(function (n) {
            var a = n;
            if (
    ...
    32168: function (e, t, n) {
      ...
      function o(e) {
        e.register(a),
          ...
          e.languages.DFS(e.languages.racket, function (t, n) {
            if ("RegExp" === e.util.type(n)) {
              var a = n.source.replace(
                /\\(.)|\[\^?((?:\\.|[^\\\]])*)\]/g,
                function (e, t, n) {
                  if (t) {
                    if ("(" === t) return "[([]";
    ...
    13808: function (e) {
      ...
      function t(e) {
        !(function (e) {
          ...
          t("csharp", a), t("fsharp", a), t("vbnet", o);
        })(e);
      }
    ...
    47529: function (e) {
      e.exports = function () {
        for (var e = {}, n = 0; n < arguments.length; n++) {
          var a = arguments[n];
          for (var o in a) t.call(a, o) && (e[o] = a[o]);
        }
        return e;
      };
