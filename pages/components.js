    ...
    <>
      ...
      <section className="pb-36 bg-white">
        <div className="container max-w-7xl mx-auto mt-36 px-4">
          ...
          <div className="mt-16">
            <h4 className="text-xl text-blue-gray-700">Block Level Buttons</h4>

            <div className="mt-5">
              <Button color="lightBlue" size="lg" ripple="light" block>
                Block level
              </Button>
            </div>
          </div>
          ...
          <div className="mt-10">
            ...
            <div className="flex flex-wrap items-center gap-8 mt-5">
              <div className="w-[28rem]">
                <Textarea color="lightBlue" placeholder="Textarea" />
              </div>
              <div className="w-[28rem]">
                <Textarea
                  color="lightBlue"
          ...
          <div className="mt-16">
            ...
            <div className="flex flex-wrap gap-x-24 gap-y-8 mt-5">
              <div className="flex flex-wrap items-end gap-8">
                ...
                <div className="w-[28rem]">
                  <Textarea color="lightBlue" placeholder="Regular" />
                </div>
              </div>
              ...
              <div className="flex flex-wrap items-end gap-8 mt-10">
                ...
                <div className="w-[28rem]">
                  <Textarea color="lightBlue" placeholder="Regular" outline />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container max-w-7xl mx-auto mt-36 px-4">
          ...
          <div className="flex flex-wrap gap-x-2 gap-y-4 mt-10">
            <Checkbox color="lightBlue" text="Checkbox" id="checkbox" />
          </div>
        </div>
        ...
        <div className="container max-w-7xl mx-auto mt-36 px-4">
          ...
          <div className="mt-16">
            <h4 className="text-xl text-blue-gray-700">Block Level Dropdown</h4>
