      ...
      <section className="bg-white" id="how-to-use">
        <div className="container max-w-7xl mx-auto px-4">
          ...
          <div className="mt-16">
            ...
            <div className="mb-16">
              <H6 color="gray">Import Material Tailwind Style Sheet</H6>
              <Paragraph color="gray">
                Import the{" "}
                <code className="text-light-blue-500">tailwind.css</code> into
                your <code className="text-light-blue-500">app.js</code> file.
            ...
            <div className="mb-16">
              <H6 color="gray">Link Material Icons Fonts to your project</H6>
              <Paragraph color="gray">
                Add a link for the material icons fonts inside the head of your
                project, so to use the material icons with material tailwind
                components. You can also use font awesome font family for the
                project just add a link for it inside the head of your project.
              </Paragraph>
