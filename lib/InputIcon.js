...
function InputIcon(_ref) {
  ...
  var label = [
    ...
    "absolute",
    "left-0",
    "".concat(outline ? "-top-1.5" : "-top-0.5"),
    "w-full",
    "h-full",
    labelBorderColor,
    "pointer-events-none",
    "".concat(!outline && "border border-t-0 border-l-0 border-r-0 border-b-1"),
    "".concat(outline && "flex"),
    "".concat(outline && size === "sm" && "text-sm"),
    "".concat(outline && "leading-10"),
    "".concat(outline && "transition-all"),
    "".concat(outline && "duration-300"),
  ];
  var sharedClasses = [
    "w-full",
    "h-full",
  ...
  var inputSM = [].concat(sharedClasses, [
    "".concat(outline ? "pl-2 pr-7" : "pl-0 pr-6"),
    "".concat(outline && "pt-1.5 pb-0.5"),
    "text-sm",
  ]);
  var inputRegular = [].concat(sharedClasses, [
    "".concat(outline ? "pl-3 pr-9" : "pl-0 pr-7"),
    "".concat(outline && "pt-2.5 pb-1.5"),
  ]);
  var inputLG = [].concat(sharedClasses, [
    "".concat(outline ? "pl-3 pr-9" : "pl-0 pr-7"),
    "".concat(outline && "pt-3.5 pb-2.5"),
  ]);
  var inputFilled = [
    mtInputBorderColor,
    "mt-input",
  ...
  var inputOutline = [
    ...
    "rounded-lg",
    "focus:border-2",
    "focus:".concat(mtInputOutlineFocusColor),
  ];
  ...
  if (size === "sm") {
    ...
    (_inputClasses = inputClasses).push.apply(
      _inputClasses,
      _toConsumableArray(inputSM)
    );
    ...
    (_inputClasses2 = inputClasses).push.apply(
      _inputClasses2,
      _toConsumableArray(inputLG)
    );
    ...
    (_inputClasses3 = inputClasses).push.apply(
      _inputClasses3,
      _toConsumableArray(inputRegular)
    );
  ...
  outline
    ? (_inputClasses4 = inputClasses).push.apply(_inputClasses4, inputOutline)
    : (_inputClasses5 = inputClasses).push.apply(_inputClasses5, inputFilled);
  container = container.join(" ");
  label = label.join(" ");
  inputClasses = inputClasses.join(" ");

  if (iconFamily === "material-icons") {
    iconUI = /*#__PURE__*/ _react["default"].createElement(
      "span",
      _extends({}, rest, {
        className: ""
          .concat(
  ...
  return /*#__PURE__*/ _react["default"].createElement(
    ...
    /*#__PURE__*/ _react["default"].createElement(
      ...
      _extends({}, rest, {
        ...
        className: ""
          .concat(inputClasses, " ")
          .concat(error && "mt-input-outline-error", " ")
          .concat(success && "mt-input-outline-success"),
      })
    ),
    /*#__PURE__*/ _react["default"].createElement(
      "label",
