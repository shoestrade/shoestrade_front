...
var Button = /*#__PURE__*/ (0, _react.forwardRef)(function (_ref, ref) {
  ...
  if (size === "sm") {
    ...
    (_classes3 = classes).push.apply(
      _classes3,
      _toConsumableArray(buttonRegular)
    );
  }
