...
function Textarea(_ref) {
  ...
  var textareaSM = [].concat(sharedClasses, [
    "".concat(outline ? "px-3" : "px-0"),
    "".concat(outline && "pt-1.5 pb-0.5"),
    "text-sm",
  ]);
  var textareaRegular = [].concat(sharedClasses, [
    "".concat(outline ? "px-3" : "px-0"),
  ...
  if (size === "sm") {
    ...
    (_textareaClasses = textareaClasses).push.apply(
      _textareaClasses,
      _toConsumableArray(textareaSM)
    );
  } else {
    var _textareaClasses2;

    (_textareaClasses2 = textareaClasses).push.apply(
      _textareaClasses2,
      _toConsumableArray(textareaRegular)
    );
  }

  outline
    ? (_textareaClasses3 = textareaClasses).push.apply(
        _textareaClasses3,
        textareaOutline
      )
    : (_textareaClasses4 = textareaClasses).push.apply(
        _textareaClasses4,
        textareaFilled
      );
