  ...
  [9397],
  {
      ...
      var g = {
        ...
        C = (0, i.forwardRef)(function (e, r) {
          var t,
            ...
            D = ["text-white", g[c], p[c], b[c], h[c], y[c], f[c]],
            E = [
              "bg-transparent",
              "border",
              "border-solid",
            ...
            _ = ["bg-transparent", m[c], w[c], j[c], w[c], k[c]],
            z = [].concat(G, [
          ...
          if ("sm" === C) (t = B).push.apply(t, (0, l.Z)(z));
          else if ("lg" === C) {
            var I;
            (I = B).push.apply(I, (0, l.Z)(F));
          } else {
            var A;
            (A = B).push.apply(A, (0, l.Z)(R));
          }
          if ("outline" === u) (o = B).push.apply(o, E);
          else if ("link" === u) {
            var U;
            (U = B).push.apply(U, _);
          } else {
          ...
          return (
            ...
            (0, n.jsx)(
              ...
              s(
                ...
                {},
                {
                  className: "".concat(B, " ").concat(S),
                  ref: r,
                  onMouseUp: function (e) {
                    "dark" === N && Z.create(e, "dark"),
                      "light" === N && Z.create(e, "light");
                  },
                  children: i,
                }
              )
    ...
    53085: function (e, r, t) {
      ...
      function d(e) {
        var r = e.children,
          t = e.activeColor,
          d = (e.activeFramework, e.onColorClick),
          ...
          children: [
            ...
            (0, o.jsxs)(a.Z, {
              children: [
                ...
                (0, o.jsx)(d.Z, { title: "Regular Modal" }),
                (0, o.jsx)(m, {
                  copyText: "Modal" === r ? "Copied" : "Copy",
                  onCopy: function (e) {
                    return t(e ? "Modal" : "");
